locals {
  ...
  build_elastic_a = var.create_private_eip ? local.build_private_a : 0
  build_elastic_b = var.create_private_eip ? local.build_private_b : 0
  build_elastic_c = var.create_private_eip ? local.build_private_c : 0
  /*
